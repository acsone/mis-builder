...
class KpiMatrix:
            ...
            for cell in row.iter_cells():
                if cell is None:
                    ...
                    col_data = {
                        ...
                        "can_be_annotated": not bool(cell.row.account_id),
                    }
    ...
    # to visual coordinates (cell id)
    @classmethod
    def _make_row_id(cls, kpi_id, account_id) -> str:
        return f"{kpi_id}:{account_id or ''}"

    @classmethod
    def _make_cell_id(cls, kpi_id, account_id, period_id, subkpi_id) -> str:
        return f"{kpi_id}#{account_id or ''}#{period_id}#{subkpi_id or ''}"

    @classmethod
    def _pack_cell_id(cls, cell):
    ...
    @classmethod
    def _unpack_cell_id(cls, cell_id: str):
